cask "nam" do
  ...
  name "NAM"
  desc <<~DESC
War is hell. And so are the graphics in this game. NAM, released in 1998, used the Build engine long after its shelf life as a mainstream option.But if you feel like trying out this ambitious but flawed attempt at realistic graphics in an engine designed for flying pigs, here's your chance.
Developer:  TNT Team
