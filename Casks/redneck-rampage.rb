cask "redneck-rampage" do
  ...
  desc "Redneck Rampage is a comedic first person shooter using the same Build engine as Duke Nukem 3D. It features a hillbilly/aliens theme and its source code was never officially released, but modern Build engine ports do a decent job with a reverse engineered version of its gameplay.
