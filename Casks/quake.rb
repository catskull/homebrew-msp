  cask "quake" do
    version :latest
    sha256 "54917a5bc24d1f679bef30d8b8357059bbfcd48ba044ee954be17fcc03b46ebf"

    url "https://github.com/MacSourcePorts/MSPBuildSystem/releases/download/vkQuake-1.32.1/vkQuake-1.32.1.dmg"
    name "Quake"
    desc <<~DESC
